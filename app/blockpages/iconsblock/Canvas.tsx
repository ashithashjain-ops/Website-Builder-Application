        ...
        {blocks.map((block) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex min-h-[360px] w-full flex-1 flex-col items-center justify-center overflow-y-auto p-8 sm:min-h-[420px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <div className="mb-6 flex items-center justify-center">
                  <IconPreview props={block.props} />
                </div>
                <p className="text-[15px] font-medium text-gray-500">{block.props.pageLabel}</p>
              </div>
            </div>
          );
        })}
