...
export default function MobileLeftSidebar({ onAddBlock, onClose }: MobileLeftSidebarProps) {
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center border border-[#1A2F5A] rounded-md overflow-hidden bg-[#0A1F4D] cursor-pointer">
                      ...
                      <input type="text" className="flex-1 text-center text-[13px] font-medium bg-transparent outline-none w-full" defaultValue="20 px" />
                    ...
                    <div className="flex items-center border border-[#1A2F5A] rounded-md overflow-hidden bg-[#0A1F4D] cursor-pointer">
                      ...
                      <input type="text" className="flex-1 text-center text-[13px] font-medium bg-transparent outline-none w-full" defaultValue="12 px" />
                      <div className="px-2 py-2 border-l border-[#1A2F5A]">
                        <ChevronDown className="w-3.5 h-3.5 text-gray-400" />
                      </div>
                    </div>
      ...
      <div className="w-full h-full flex flex-col bg-[#06183C] text-white rounded-t-3xl overflow-hidden relative border-2 border-[#1E88E5]">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
           ...
           <div className="flex items-center gap-[6px] mb-6">
              <button onClick={() => setActiveColor(0)} className={`w-[26px] h-[26px] rounded-[4px] border ${activeColor === 0 ? 'border-white' : 'border-[#1A2F5A]'} flex items-center justify-center bg-[#0A1F4D] transition-transform hover:scale-110`}><Ban className="w-4 h-4 text-gray-400" /></button>
              ...
              <button onClick={() => setActiveColor(2)} className={`w-[26px] h-[26px] rounded-[4px] bg-gradient-to-r from-[#94ff24] via-[#ff2f2f] to-[#ff2f2f] ${activeColor === 2 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(3)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#EF4444] ${activeColor === 3 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(4)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#22C55E] ${activeColor === 4 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(5)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#3B82F6] ${activeColor === 5 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(6)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#EAB308] ${activeColor === 6 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(7)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#FCA5A5] ${activeColor === 7 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(8)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#D97706] ${activeColor === 8 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(9)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#D8B4FE] ${activeColor === 9 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(10)} className={`w-[26px] h-[26px] rounded-[4px] bg-[#EC4899] ${activeColor === 10 ? 'ring-2 ring-white' : ''} transition-transform hover:scale-110`}></button>
              <button onClick={() => setActiveColor(11)} className={`w-[26px] h-[26px] rounded-[4px] bg-white ${activeColor === 11 ? 'ring-2 ring-blue-500' : ''} transition-transform hover:scale-110`}></button>
           </div>
           ...
           <div className="mb-6">
              ...
              <div className="flex items-center justify-between">
                 <div className="flex items-center border border-[#1A2F5A] rounded-md overflow-hidden bg-[#0A1F4D]">
                    <button onClick={() => setActiveAlign('left')} className={`px-[10px] py-[6px] border-r border-[#1A2F5A] focus:outline-none transition-all duration-300 hover:scale-105 ${activeAlign === 'left' ? 'bg-white/10' : 'hover:bg-white/5'}`}><AlignLeft className="w-4 h-4 text-gray-300" /></button>
                    <button onClick={() => setActiveAlign('center')} className={`px-[10px] py-[6px] border-r border-[#1A2F5A] focus:outline-none transition-all duration-300 hover:scale-105 ${activeAlign === 'center' ? 'bg-white/10' : 'hover:bg-white/5'}`}><AlignCenter className="w-4 h-4 text-gray-300" /></button>
                    <button onClick={() => setActiveAlign('right')} className={`px-[10px] py-[6px] focus:outline-none transition-all duration-300 hover:scale-105 ${activeAlign === 'right' ? 'bg-white/10' : 'hover:bg-white/5'}`}><AlignRight className="w-4 h-4 text-gray-300" /></button>
                 </div>
                 
                 <div className="flex items-center border border-[#1A2F5A] rounded-full overflow-hidden bg-[#2D4571] px-1 py-1">
                    <button className="p-1 hover:bg-white/10 focus:outline-none rounded-full transition-transform hover:scale-110 hover:rotate-90"><RotateCw className="w-3.5 h-3.5 text-white" /></button>
                    <button className="p-1 hover:bg-white/10 focus:outline-none rounded-full transition-transform hover:scale-110 hover:-rotate-90"><FlipVertical className="w-3.5 h-3.5 text-white" /></button>
                    <button className="p-1 hover:bg-white/10 focus:outline-none rounded-full transition-transform hover:scale-110 hover:rotate-90"><FlipHorizontal className="w-3.5 h-3.5 text-white" /></button>
                 </div>
              ...
              <div className="flex items-center gap-3">
                 {[0, 1, 2, 3].map((val, i) => (
                    <div key={i} className="flex items-center gap-2 border border-[#1A2F5A] rounded-md bg-[#0A1F4D] px-2.5 py-1.5 flex-1 justify-center focus-within:border-blue-500 transition-colors">
                       ...
                       <input type="text" defaultValue="0" className="w-full bg-transparent outline-none text-[14px] text-center" />
                    </div>
                 ))}
              </div>
           </div>
